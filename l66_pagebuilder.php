...
<div style="float:left;background-color:#CEF6CE;width:50%;height:250px">
	...
	<?PHP if (get_option('l66_modus') == "freebie") {?> onClick="this.checked=false; alert('Sorry, this option is not available in the free version. Please consider upgrading to PREMIUM membership. You can do so on the bottom of this screen.')"
	<?PHP ;} ?>
	> all of them **
	<hr><br>
</div>
