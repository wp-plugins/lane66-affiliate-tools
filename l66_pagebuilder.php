...
<div style="float:left;background-color:#CEF6CE;width:50%;height:250px">
	...
	<input type="radio" name="product" value="20" <?PHP if (get_option('l66_modus') == "freebie") {?> onClick="this.checked=false; alert('Sorry, this option is not available in the free version. Please consider upgrading to PREMIUM membership. You can do so on the bottom of this screen.')" <?PHP ;} ?>
	> 20 
	<input type="radio" name="product" value="100" <?PHP if (get_option('l66_modus') == "freebie") {?> onClick="this.checked=false; alert('Sorry, this option is not available in the free version. Please consider upgrading to PREMIUM membership. You can do so on the bottom of this screen.')" <?PHP ;} ?>
	> 100
	<input type="radio" name="product" value="999999" <?PHP if (get_option('l66_modus') == "freebie") {?> onClick="this.checked=false; alert('Sorry, this option is not available in the free version. Please consider upgrading to PREMIUM membership. You can do so on the bottom of this screen.')" <?PHP ;} ?>
	> all of them **
	<hr><br>
</div>
...
$lay = "http://lane66.com/l66/layouttry.php?iam=".$bl."&view=1";
$ch = curl_init();
