...
<input type="submit" name="Submit" value="<?php _e('Destroy and remove all products from the database ?')?>" />
</form>	
<?PHP
...
<HR>
Below is a list of items in your upload directory. Select some to delete them.<br>
