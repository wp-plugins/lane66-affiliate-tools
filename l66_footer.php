...
<p align="center">
<b>Version 1.3</b> | lane66.com - affiliate tools PRO | Project-leader: <a href="http://portaljumper.com/discuss" target="_blank" title="get hold of pete by writing in the forum. Simply click and a new page will open up.">Pete Scheepens</a></p>
...
<hr>Believe it or not, but a lot of our users make a lot of money with our plugins.<br>Every now and then they land a big commission on a single click. It's like winning the lottery or jack-pot.<br>
Just as people tip their dealers on a big winning, you can tip the developers that helped you with this software if you land a good commission. Simply use the donate button below, and if you want to we'll even put you in the spotlight.<br>
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
