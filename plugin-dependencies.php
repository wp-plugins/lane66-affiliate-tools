<?php
/*
Plugin Name: lane66 Plugin Dependencies
Version: 1.0.1
Description: This plugin was bundled with *** LANE66.com affiliate tools CORE ***. We (lane66.com) highly recommend activating this plugin when installing add-on's. It prevent activating plugins that don't have all their dependencies satisfied
Author: scribu
