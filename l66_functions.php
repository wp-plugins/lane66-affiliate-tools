    ...
    {	
		echo "<div style='background-color:red;color:white'>Writing tables ! This is a one-time process - reload page or just continue !</div>";
		 mysql_query("CREATE TABLE " . $table_name . " (
		  ...
		  sku VARCHAR(260) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,	  
		  ...
		  tags VARCHAR(260) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
		  ...
		  cust1 VARCHAR( 200 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
		  cust2 VARCHAR( 200 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
		  cust3 VARCHAR( 200 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
		...
		or die(mysql_error());
					...
					/*
					 $sql = "CREATE TABLE " . $table_name . " (
					  ...
					  feedname VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  sku VARCHAR(260) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,	  
					  title VARCHAR(260) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  descr VARCHAR(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  cat VARCHAR(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  cat2 VARCHAR(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  cat3 VARCHAR(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  tags VARCHAR(260) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  link VARCHAR(260) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  image VARCHAR(260) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  price VARCHAR(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  retailprice VARCHAR(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  currency VARCHAR(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  cust1 VARCHAR( 260 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  cust2 VARCHAR( 260 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  cust3 VARCHAR( 260 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					  timein int(10) DEFAULT '0' NOT NULL,
					  timeupdate int(10) DEFAULT '0' NOT NULL,
		_			  manual TINYINT(2) DEFAULT '0' NOT NULL,
					  UNIQUE KEY id (id),
					  UNIQUE KEY title (title)
					);";
...
$table_name = $wpdb->prefix ."lane66_feeds";
$keyword = $atts['key'];
if ($keyword == "notset") $keyword = "";
																						//echo "KEYWORD".$keyword;
$thefeeds = $atts['feeds'];
$thefeeds = str_replace("+"," ",$thefeeds);
$thefeeds = str_replace(",","' or '",$thefeeds); // 'Online Sports' or 'Young Lovers'
...
$chk = "http://lane66.com/l66/gopro.php?iam=".$bl."&req=1&adm=".$adm;
$ch = curl_init();
