...
<?PHP echo "your php.ini allows a maximum of ".ini_get('post_max_size')." for post-size and a max of ".ini_get('upload_max_filesize')."for upload"; ?><br>
	<!-- form for upload -->
...
<?PHP $display_fl = get_option( "l66_file_location" ); echo"<small>Now working with: $display_fl </small>"; ?>
<div>	
<?php
