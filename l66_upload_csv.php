...
<a href="admin.php?page=l66_upload_csv&l66info=min"><font color='green'>less info</font></a>|<a href="admin.php?page=l66_upload_csv&l66info=max">show help & info</a>
<?PHP
...
if( $_POST['before'] == 'Y' ) 
	...
	{ 
	echo
	"<font color='green'>Locate your own CSV datafile on your computer and upload it to the warehouse. Once your datafeed is converted and the products have
...
<div style="clear:both;text-align:center;"><?PHP $display_fl = get_option( "l66_file_location" ); echo"<small>Now working with: $display_fl </small>"; ?>
<div>	
<?php
...
<?php 
	...
	your datafeed provides you or if you want to overrule a certain field you can use the manual override boxes. Anything you type in the manual override boxes will be fixed in place for
	 this entire datafeed. (It's great for setting tags or replacing links with 1 fixed link etc. Be creative ....<br>
	 <object width='640' class='thickbox' height='385'><param name='movie' value='http://www.youtube.com/v/JhhlzKTY8ng?fs=1&amp;hl=nl_NL'></param><param name='allowFullScreen' value='true'></param><param name='allowscriptaccess' value='always'></param><embed src='http://www.youtube.com/v/JhhlzKTY8ng?fs=1&amp;hl=nl_NL' type='application/x-shockwave-flash' allowscriptaccess='always' allowfullscreen='true' width='640' height='385'></embed></object>
	 <br>More info on loading 'tricky' csv feeds coming soon. Remember, we're not yet at version 1.0 !! (examples: like ones not having first lines with column names, or feeds with 100 columns) 
	 <hr>
	 <h3>Close additional info & de-clutter by clicking 'less info' on the top left corner of your screen'</h3>
	 </font>
	";
...
{ echo "<font color='green'>Please hit 'Process feed!' without checking the box as much as needed until you are satisfied with your preview (Do it now!) When your preview is good, check the box and hit 'Proceed..' again to fill database.</font>";}	
?>
<hr>
