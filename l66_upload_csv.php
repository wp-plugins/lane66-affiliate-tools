...
if( $_POST['upload'] == 'Y' ) 
	...
	{echo "<CENTER><h1> YOU HAVE BEEN FLAGGED FOR ACCOUNT BLOCKING !<br>YOU HAVE NOW USED OR SERVER ".get_option('l66_freebie_count')." TIMES<br> AND ARE still OPERATING IN FREEBIE MODE<br>
	<br>AN ADMINISTRATOR HAS BEEN NOTIFIED<br> ABOUT YOUR USE OF THE SYSTEM.<br> THE ADMINISTRATOR MAY DETERMINE THAT<br> YOUR ACCOUNT IS TO BE BLOCKED !<br>Please swith to PREMIUM mode or stop using our system !</h1>";
	}
	?>
	 </div>
