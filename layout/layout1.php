...
$view = $wpdb->get_results("SELECT * FROM $table_name  WHERE title LIKE '%$keyword%' AND feedname = '$thefeeds' $order LIMIT $limit"); 
		foreach ($view as $row) 
	{
			...
			<DIV style="font-family:times new roman;font-size:10pt;float:left;height:200px;overflow:hidden;width:300px">
				...
				{echo "<div style='float:left;font-size:8pt;font-weight:200;color:#BDBDBD'><a href='http://lane66.com' alt='lane66.com affiliate tools PRO-series' title='lane66.com affiliate tools PRO-series'><font color='#E6E6E6'>lane66.com</font></a></div>";} ?>
