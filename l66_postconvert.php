...
if (isset($_POST['post1'])) 
		...
		if (get_option('l66_modus') == "PREMIUM") 
			{
			$content.="
			<br><A href='$row->link' title='$row->descr'><img src='http://images.shrinktheweb.com/xino.php?stwembed=1&stwxmax=100&stwymax=75&stwaccesskeyid=2cc62cc1c1c7d5e&stwurl=$row->link' border=0 /></a>
			";
			}
