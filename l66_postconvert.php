...
if (function_exists('l66_cloak_track')) {l66_cloak_track();}
...
if (isset($_POST['post1'])) 
		...
		if (empty($vals)) 
			...
			foreach ($view as $row) 
			{
			if ($l66_cloak_track) {$row->link = "http://localhost:8080/wp-admin/admin.php?page=l66_track&f={$row->feedname}&t={$row->title}&ty=post&pr=".$wpdb->prefix;}
