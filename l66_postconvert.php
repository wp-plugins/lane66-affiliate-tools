...
if (isset($_POST['post1'])) 
		...
		if (get_option('l66_modus') == "freebie") 
			{
			$content.="<div style='clear:both;height:1'></div><hr><div style='clear:both;text-align:center;color:#BDBDBD;font-size:10px;'>Created with a free version of <a href='http://lane66.com' title='lane66.com builds professional affiliate plugins to help you make money with datafeeds. Most of their plugins are free. Visit them now ....'>lane66.com</a> affiliate tools PRO-series</div><div style='clear:both;height:1'></div>";
			}
...
?>
	...
	<input type="text" name="tags" value="lane66.com,datafeed" size="40"/> <hr>
	...
	<input type="radio" name="skipnopic" value="on" <?PHP if (get_option('l66_modus') == "freebie") {?>
	...
	<?PHP if (get_option('l66_modus') == "freebie") {?>
	onClick="this.checked=false; alert('Sorry, this option is not available in the free version. Please consider upgrading to PREMIUM membership. You can do so on the bottom of this screen.')"
	<?PHP ;} ?>
	> 100
	...
	> all of them
		...
		<div style="float:left">
			<div>
			<h3>Now tell us from which feeds I can select products to build posts -></h3> 
			</div>
