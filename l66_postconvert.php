...
if (isset($_POST['post1'])) 
		...
		if (get_option('l66_modus') == "freebie") 
			{
			$content.="<div style='clear:both;height:1'></div><hr><div style='clear:both;text-align:center;color:#BDBDBD'><small>Created with a free version of <a href='http://lane66.com'>lane66.com</a> affiliate tools PRO-series</small></div><div style='clear:both;height:1'></div>";
			}
